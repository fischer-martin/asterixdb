...
public class LocalSummaryTwoAggregateDescriptor extends AbstractSummaryTwoAggregateDescriptor {
    private static final long serialVersionUID = 1L;
    public static final IFunctionDescriptorFactory FACTORY =
            AbstractAggregateFunctionDynamicDescriptor.createFactory(LocalSummaryTwoAggregateDescriptor::new);

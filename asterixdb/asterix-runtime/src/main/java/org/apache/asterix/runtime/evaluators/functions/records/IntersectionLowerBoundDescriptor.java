...
public class IntersectionLowerBoundDescriptor extends AbstractScalarFunctionDynamicDescriptor {
    ...
    public static final IFunctionDescriptorFactory FACTORY = new IFunctionDescriptorFactory() {
        ...
        public IFunctionDescriptor createFunctionDescriptor() {
            return new IntersectionLowerBoundDescriptor();
        }

        @Override
        public IFunctionTypeInferer createFunctionTypeInferer() {
            return new FunctionTypeInferers.IntersectionLowerBoundTypeInferer();
        }
    };
    ...
    public IScalarEvaluatorFactory createEvaluatorFactory(final IScalarEvaluatorFactory[] args) {
        return new IScalarEvaluatorFactory() {
            ...
            public IScalarEvaluator createScalarEvaluator(IEvaluatorContext ctx) throws HyracksDataException {
                return new IntersectionLowerBoundEvaluator(args, ctx, sourceLoc, type1, type2);
            }
        };
    }

...
public class ThetaFlexibleJoiner {
    ...
    public void build(ByteBuffer buffer) throws HyracksDataException {
        ...
        for (int i = 0; i < tupleCount; i++) {
            ...
            newBucket = false;
            int bucketId = FlexibleJoinsUtil.getBucketId(accessorBuild, i, buildKeys[0]);
    ...
    public void probe(ByteBuffer buffer, IFrameWriter writer) throws HyracksDataException {
        ...
        for (int i = 0; i < tupleCount; ++i) {
            ...
            for (int bucketIndex = 0; bucketIndex < numberOfBuckets; bucketIndex++) {
                ...
                buff.position(buildKeys[0] * 4 + 5 + 4);
                ...
                if (this.tpComparator.compare(iFrameTupleAccessor, 0, accessorProbe, i) < 1) {
                    ...
                    if (bucketInfo[1] > -1) {
                        ...
                        while (frameCounter <= nextBucket.getFrameIndex()) {
                            ...
                            int tupleStop = (frameCounter == nextBucket.getFrameIndex() && nextBucket.getTupleIndex() != -1)?nextBucket.getTupleIndex():memoryAccessor.getTupleCount();

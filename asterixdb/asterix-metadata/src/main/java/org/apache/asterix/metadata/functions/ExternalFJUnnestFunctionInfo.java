...
public class ExternalFJUnnestFunctionInfo extends ExternalFunctionInfo {

    private static final long serialVersionUID = 3L;

    public ExternalFJUnnestFunctionInfo(FunctionIdentifier fid, List<IAType> parameterTypes, IAType returnType,
            ...
            boolean nullCall) {
        super(fid, FunctionKind.FJ_UNNEST, parameterTypes, returnType, rtc, language, libraryDataverseName, libraryName,

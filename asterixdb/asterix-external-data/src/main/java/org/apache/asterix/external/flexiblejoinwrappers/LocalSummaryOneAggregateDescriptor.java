...
public class LocalSummaryOneAggregateDescriptor extends AbstractSummaryOneAggregateDescriptor implements IExternalFunctionDescriptor {
    private static final long serialVersionUID = 1L;

    private final IExternalFunctionInfo finfo;

    public LocalSummaryOneAggregateDescriptor(IExternalFunctionInfo finfo) {
        this.finfo = finfo;
    }

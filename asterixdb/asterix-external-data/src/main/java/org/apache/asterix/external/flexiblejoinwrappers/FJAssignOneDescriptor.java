...
public class FJAssignOneDescriptor extends AbstractUnnestingFunctionDynamicDescriptor implements IExternalFunctionDescriptor {
    private static final long serialVersionUID = 1L;

    private final IExternalFunctionInfo finfo;


    public FJAssignOneDescriptor(IExternalFunctionInfo finfo) {
        this.finfo = finfo;
    }

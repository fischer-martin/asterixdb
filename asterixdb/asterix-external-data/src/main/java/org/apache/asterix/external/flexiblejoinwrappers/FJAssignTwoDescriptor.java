...
public class FJAssignTwoDescriptor extends AbstractUnnestingFunctionDynamicDescriptor implements IExternalFunctionDescriptor {
                ...
                return new IUnnestingEvaluator() {
                    ...
                    public boolean step(IPointable result) throws HyracksDataException {
                        ...
                        if (AlgebricksConfig.ALGEBRICKS_LOGGER.isDebugEnabled()) {
                            AlgebricksConfig.ALGEBRICKS_LOGGER.info("Assign Two step : " + buckets[pos] + " ID: "

...
public class BucketComparatorFactory implements IBucketPairComparatorFactory {
    ...
    public BucketComparatorFactory(IBinaryComparatorFactory bFactory, int pos0, int pos1) {
    ...
    @Override
    public IBucketPairComparator createTuplePairComparator(IHyracksTaskContext ctx) {
        return new BucketComparator(bFactory.createBinaryComparator(), pos0, pos1);
    }
